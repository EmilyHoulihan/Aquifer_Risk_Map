...
welldata <- read.table("domwqdata_clean2021-05-26.txt", stringsAsFactors = F, header = T)
domwells <- read.delim("domwells2021-05-25.txt", stringsAsFactors = F)
...
oswcr_dates <- read.csv("Datasets/oswcr_dom_date1970na_new.csv", stringsAsFactors = F)
...
sum_test <- cbg3 %>% select(-GEOID) %>% distinct()
sum(sum_test$dom_wells1970na)

totaloswcr_1970na <- 325749
